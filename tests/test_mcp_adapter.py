...
class McpAdapterTests(unittest.TestCase):
    ...
    def test_editor_serializes_browser_line_breaks_and_prepares_png_download(self):
        ...
        self.assertIn("v1.35", html)
        self.assertNotIn("v1.35 TEST", html)
...
class McpProtocolTests(unittest.TestCase):
    ...
    def test_preview_ui_resource_is_a_portable_mcp_app(self):
        ...
        resource = next(
            ...
            if str(item.uri) == "ui://quote-card-builder/preview/v1.35.html"
        )
        self.assertEqual(
        ...
        contents = asyncio.run(
            mcp_server.mcp.read_resource("ui://quote-card-builder/preview/v1.35.html")
        )
    ...
    def test_cached_preview_resource_versions_serve_the_current_editor(self):
        ...
        for version in (26, 27, 28, 29, 30, 31, 32, 33, 34):
            ...
            self.assertEqual(1, len(contents))
            self.assertIn("v1.35", contents[0].content)
