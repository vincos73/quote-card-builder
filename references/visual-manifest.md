...
3. Consentire una o più linee senza un limite fisso e almeno una riga di testo; una stringa vuota è una riga intera di spazio verticale e non modifica la ricostruzione del testo. Il renderer adatta dinamicamente il corpo al canvas.
